...
export async function access() {
  return request<API.BaseResponse<API.SystemsAccessProps[]>>('/api/systems/access/list');
}
...
export async function accessDelete(authId: string) {
  return request<API.BaseResponse<any>>(`/api/systems/access/remove/${authId}`, {
    method: "DELETE"
  });
}
...
export async function roles() {
  return request<API.BaseResponse<API.SystemRoleProps[]>>('/api/systems/roles/list');
}
 ...
 **********************/
 export async function users(data: any = {}) {
  return request<API.BaseResponse<API.SystemsUserProps[]>>('/api/administrators/list', {
    method: "POST",
    data
  });
}
...
export async function userSwichStatus(id: string) {
  return request<API.BaseResponse<any>>(`/api/administrators/switch-status/${id}`, {
    method: "PUT"
  });
}
